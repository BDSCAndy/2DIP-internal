...
def frame_1():# Login 
    ...
    welcome=Label(frame1,text=" WELCOME TO THE BDSC MENU APP!",font=("Arial",18,),background="#5a183a",fg="White")
...
def frame_5():#Snacks
    ...
    box4 = scrolledtext.ScrolledText(frame5,width=32,height=10)
